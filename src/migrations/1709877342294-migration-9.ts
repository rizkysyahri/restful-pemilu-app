...
export class Migration91709877342294 implements MigrationInterface {
    name = 'Migration91709877342294'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "vote" ADD "candidateId" integer`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "vote" DROP COLUMN "candidateId"`);
